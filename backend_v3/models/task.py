...
class DubbingTask(BaseModel):
    ...
    voice: Optional[str] = Field(
        default=None, description="Engine-specific voice name/ID used for synthesis."
    )
    tts_engine: Optional[str] = Field(
        default=None,
        description="TTS engine used for synthesis (e.g. 'edge', 'gtts', 'azure', 'piper', "
        "'xtts', 'elevenlabs'). None means the server's configured DEFAULT_TTS_ENGINE was used.",
    )
